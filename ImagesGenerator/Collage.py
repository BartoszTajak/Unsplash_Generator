...
class CollageCreator():
    ...
    def main(self, place):
        path = f"images/{place}/{place}_Converted"
        ...
        for image in list_of_photos:
            image_one = Image.open(f"images/{place}/{place}_Converted/{image}")
        ...
        img.save(f"images/{place}/{place}_Converted/Collage.png", "PNG")
