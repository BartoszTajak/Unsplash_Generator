...
def main(target: str, number: int, catalog: str, grey_scale: bool, gaussian: int,rowsAndColumns: int, padding: int):
    p = ImagesGenerator(target, number, catalog)
    p.converting_images(grey_scale, gaussian, (800, 800))
    collage = CollageCreator(rowsAndColumns, padding)
    collage.main(catalog)


if __name__ == "__main__":
    main('Brasil', 10, 'Brasil', True, 0, 3, 10)
